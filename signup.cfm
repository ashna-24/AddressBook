                ...
                <div class="form flex">
                    ...
                    <div class="form_login">
                        ...
                        <form action="" method="post" name="myform" onsubmit="return validateform()">
                            ...
                            <span id="fname_error">Please fill this field!</span>
                            <input type="email" name="mail" class="text" placeholder="Email ID" id="mail" onblur="validateform()"></br>
                            <span id="mail_error">Please fill this field!</span>
                            ...
                            <span id="conpswd_error">Please fill this field!</span>
                            <span id="conform">Password did not match: Please try again...</span>
